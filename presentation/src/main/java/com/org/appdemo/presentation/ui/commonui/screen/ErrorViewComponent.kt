package com.org.appdemo.presentation.ui.commonui.screen
...
import com.org.appdemo.presentation.ui.commonui.Constants

@Composable
fun ErrorViewComponent(message: String, code: String) {
    when (code) {
        Constants.NO_INTERNET -> ErrorView(
