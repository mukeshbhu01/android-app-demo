...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxCoreLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>test</b> with <b>androidx.arch.core:core-testing</b> coordinates and
    ...
    public static class AndroidxTestLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getMockk() {
            return create("androidx.test.mockk");
        }
    ...
    public static class HiltNavigationLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>hiltNavigaitonCompose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompose() {
    ...
    public static class ImageLibraryAccessors extends SubDependencyFactory {
        private final ImageLoadingLibraryAccessors laccForImageLoadingLibraryAccessors = new ImageLoadingLibraryAccessors(owner);

        public ImageLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>image.loading</b>
         */
        public ImageLoadingLibraryAccessors getLoading() {
            return laccForImageLoadingLibraryAccessors;
        }

    }

    public static class ImageLoadingLibraryAccessors extends SubDependencyFactory {

        public ImageLoadingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getCoil() {
            return create("image.loading.coil");
        }
    ...
    public static class NetworkLibraryAccessors extends SubDependencyFactory {
        private final NetworkHttpLibraryAccessors laccForNetworkHttpLibraryAccessors = new NetworkHttpLibraryAccessors(owner);
        private final NetworkRetrofitLibraryAccessors laccForNetworkRetrofitLibraryAccessors = new NetworkRetrofitLibraryAccessors(owner);

        public NetworkLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>network.http</b>
         */
        public NetworkHttpLibraryAccessors getHttp() {
            return laccForNetworkHttpLibraryAccessors;
        }

        /**
         * Group of libraries at <b>network.retrofit</b>
         */
        public NetworkRetrofitLibraryAccessors getRetrofit() {
            return laccForNetworkRetrofitLibraryAccessors;
        }

    }

    public static class NetworkHttpLibraryAccessors extends SubDependencyFactory {

        public NetworkHttpLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         */
        public Provider<MinimalExternalModuleDependency> getBom() {
            return create("network.http.bom");
        }

        /**
         * Dependency provider for <b>client</b> with <b>com.squareup.okhttp3:okhttp</b> coordinates and
         * with version reference <b>okHttp3</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getClient() {
            return create("network.http.client");
        }
        ...
        public Provider<MinimalExternalModuleDependency> getLogging() {
            return create("network.http.logging");
        }

    }

    public static class NetworkRetrofitLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public NetworkRetrofitLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getConverter() {
            return create("network.retrofit.converter");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>hiltNavigaitonCompose</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getHiltNavigaitonCompose() { return getVersion("hiltNavigaitonCompose"); }
        ...
        /**
         * Version alias <b>kspVersion</b> with value <b>1.9.25-1.0.20</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>serializationPlugin</b> with value <b>1.9.24</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class NetworkBundleAccessors extends BundleFactory {
        ...
        /**
         * Dependency bundle provider for <b>network.client</b> which contains the following dependencies:
         * <ul>
        ...
        public Provider<ExternalModuleDependencyBundle> getClient() {
            return createBundle("network.client");
        }
